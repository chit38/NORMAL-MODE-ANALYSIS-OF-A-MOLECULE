...
CONTAINS
  ...
  SUBROUTINE line_search_backtrack(x_old,f_old,g,b,step_max,x,converged)
!
    USE kinds, ONLY : dp
    USE system, ONLY : n
    USE function_derivative, ONLY : func
    IMPLICIT NONE
!
...
!            print *, "                 |bt| cubic| lambda_new changed =", lambda_new
       ...
       IF(niter>maxiter)THEN
         PRINT *, "Warning! Linesearch has reached maximum iteration", niter
         EXIT iteration
       END IF
